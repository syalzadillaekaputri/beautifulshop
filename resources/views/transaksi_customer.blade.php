                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($transaksi as $key => $item)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td><a href="{{url('riwayat-transaksi/detail_customer')}}/{{$item->id}}">#{{$item->tanggal}}</a></td>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($item->status == 1)
                                            <a href="{{url('konfirmasi')}}/{{$item->id}}" class="btn btn-sm btn-success"><i class="fa fa-check"></i> Confirmation</a>
